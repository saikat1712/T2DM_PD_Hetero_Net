...
# -*- coding: utf-8 -*-
"""
Created on Fri May  6 17:20:46 2022
...
# all_subnet_frames=[final_df_path,final_df_genecoexpression,final_df_path_gene,final_df_snp,final_df_path_icd,final_df_snp_ptm,final_df_snp_dmg,final_df_snp_icd,final_df_amyloid_ppi_ptm_net,final_df_amy_central_icd]
...
Heterogeneous_Network_final = pd.read_csv('/home/saikat/diabetes/final_heterogeneous_network_bidirectional.csv',nrows=100)
...
Heterogeneous_Network_final.to_csv("/home/saikat/diabetes/final_hetero_bidirectional_network_with_edge_types_test.csv",index=None)        
