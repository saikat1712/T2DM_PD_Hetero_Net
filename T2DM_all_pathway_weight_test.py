...
modules=[]
with open("/home/saikat/T2DM_test/modcolor_node_files.txt") as f:
    for line in f:
        ind=line.strip('\n')
...
def pathway_weight_cal(fname,n):
    ...
    path_df_with_semantic_pheno.to_csv(r"/home/saikat/T2DM_test/sem_pheno_modules/path_path_{}_sem_pheno.csv".format(n),sep=',',index=None,header=True) 
...
i=0
for n in modules:
    for filename in listdir("/home/saikat/T2DM_test"):
        if n in filename:
